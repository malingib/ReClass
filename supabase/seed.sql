-- eShule seed: Malingi High School (tenant #1)
INSERT INTO public.tenants (id, name, slug, brand_primary, currency, timezone, sms_sender_id, academic_year)
VALUES ('11111111-1111-1111-1111-111111111111', 'Malingi High School', 'malingi-high', '#0f7a4d', 'KES', 'Africa/Nairobi', 'ESHULE', '2026');
