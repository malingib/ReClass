...
-- Function to get all dashboard counts in one query
...
-- Function to get attendance overview with joined data
...
-- Create SIS stats view for quick access
...
-- Create helper functions to create these objects (for migrations)
