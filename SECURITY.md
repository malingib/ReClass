...
> Current-state note (2026-08-01): read [AUDIT-2026-08.md](AUDIT-2026-08.md) first. This document contains detailed July findings; several controls have since improved (credential encryption, callback fail-closed behavior, import allowlisting/bounds, Postgres-backed rate limiting, and CSP), while the remaining risks are re-rated in the current report.
