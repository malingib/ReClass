...
export const MODULES = {
  ...
  _platform: {
    ...
    kind: 'kernel',
    name: 'Platform',
    description: 'Kernel: settings, integrations, users, credentials, audit.',
    status: 'available',
    icon: 'reports',
    accent: 'slate',
    provisionable: false,
    ...
    serverDir: '_platform',
    mayImport: [],
    ownsRouteGroups: ['admin/modules', 'admin/credentials'],
    routes: ['/admin/credentials', '/admin/settings', '/admin/notifications', '/admin/users'],
    dbDomain: null,
  },
  _auth: {
    id: 'auth',
