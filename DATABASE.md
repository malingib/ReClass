...
> Current-state note (2026-08-01): the consolidated current audit is [AUDIT-2026-08.md](AUDIT-2026-08.md). Verify all migration and RLS statements against a live disposable database; this document records the prior detailed analysis and known replay concerns.
