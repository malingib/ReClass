...
export const roleLabels: Record<Role, string> = {
  super_admin: 'Super Admin', school_admin: 'Admin', principal: 'Principal', teacher: 'Teacher',
  remedial_teacher: 'Remedial Teacher', bursar: 'Bursar', payroll: 'Payroll',
  reclass_chair: 'ReClass Chair', reclass_secretary: 'ReClass Secretary',
  reclass_treasurer: 'ReClass Treasurer', reclass_member: 'ReClass Committee Member', parent: 'Parent',
};

export const roleHome: Record<Role, string> = {
  super_admin: '/super-admin', school_admin: '/admin', principal: '/principal', teacher: '/teacher',
  remedial_teacher: '/teacher', bursar: '/bursar', payroll: '/payroll',
  reclass_chair: '/teacher/committee', reclass_secretary: '/teacher/committee',
  reclass_treasurer: '/teacher/committee/payroll', reclass_member: '/teacher/committee', parent: '/parent',
};
