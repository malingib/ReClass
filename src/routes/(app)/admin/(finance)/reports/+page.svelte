...
<DashboardContent title="Reports" subtitle="Exports that feed principal weekly reviews">
  ...
  <div class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
    ...
    >
      ...
      <div>
        <h3 class="text-sm font-semibold text-foreground">Teacher Attendance Report</h3>
        <p class="mt-1 text-xs text-muted-foreground">Attendance by teacher and period — CSV download</p>
      </div>
    ...
    >
      ...
      <div>
        <h3 class="text-sm font-semibold text-foreground">Revenue Report</h3>
        <p class="mt-1 text-xs text-muted-foreground">Collections by term — CSV download</p>
      </div>
      <span class="mt-auto inline-flex w-fit items-center gap-1 text-xs font-semibold text-primary group-hover:text-primary/80">
        Download CSV
        <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m9 5 7 7-7 7" /></svg>
    ...
    >
      ...
      <div>
        <h3 class="text-sm font-semibold text-foreground">Students Export</h3>
        <p class="mt-1 text-xs text-muted-foreground">All enrolled students — CSV download</p>
      </div>
      <span class="mt-auto inline-flex w-fit items-center gap-1 text-xs font-semibold text-primary group-hover:text-primary/80">
        Download CSV
        <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m9 5 7 7-7 7" /></svg>
    ...
    >
      ...
      <div>
        <h3 class="text-sm font-semibold text-foreground">Teachers Export</h3>
        <p class="mt-1 text-xs text-muted-foreground">All active teachers — CSV download</p>
      </div>
      <span class="mt-auto inline-flex w-fit items-center gap-1 text-xs font-semibold text-primary group-hover:text-primary/80">
        Download CSV
        <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m9 5 7 7-7 7" /></svg>
    ...
    >
      ...
      <div>
        <h3 class="text-sm font-semibold text-foreground">Subjects Export</h3>
        <p class="mt-1 text-xs text-muted-foreground">All subjects on offer — CSV download</p>
      </div>
      <span class="mt-auto inline-flex w-fit items-center gap-1 text-xs font-semibold text-primary group-hover:text-primary/80">
        Download CSV
        <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m9 5 7 7-7 7" /></svg>
    ...
    >
      ...
      <div>
        <h3 class="text-sm font-semibold text-foreground">Receipts Export</h3>
        <p class="mt-1 text-xs text-muted-foreground">All payment receipts — CSV</p>
      </div>
      <span class="mt-auto inline-flex w-fit items-center gap-1 text-xs font-semibold text-primary group-hover:text-primary/80">
        Open export
        <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m9 5 7 7-7 7" /></svg>
