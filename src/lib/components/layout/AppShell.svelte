...
<div class="flex h-screen bg-transparent text-ink-700">
  <!-- Sidebar -->
  <aside class={isModuleHub ? 'hidden' : 'hidden w-64 shrink-0 flex-col border-r border-border bg-white text-ink-700 md:flex'}>
    <div class="flex h-[4.5rem] items-center gap-3 border-b border-border px-5">
      ...
      {:else}
        <div class="flex items-center gap-3">
          <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-brand-600 text-sm font-bold text-white shadow-sm">e</div>
          <div class="leading-tight">
            <p class="text-sm font-semibold text-ink-900">eShule</p>
            <p class="text-[11px] text-ink-500">School Management</p>
          </div>
        </div>
      {/if}
    </div>
  ...
  <div class="flex-1 flex flex-col min-w-0">
    <header class="flex h-16 shrink-0 items-center gap-4 border-b border-border bg-white px-4 lg:px-6">
      <div class="flex min-w-0 items-center gap-3">
        ...
        <div class="min-w-0">
          <p class="truncate text-sm font-semibold tracking-tight text-ink-900">{currentModule?.name ?? 'eShule'}</p>
